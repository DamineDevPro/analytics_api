...
class Export(APIView):
    def get(self, request):
        try:
            ...
            # if _type == 4:
            #     try:
            #         store_category_id = request.GET["storeCategoryId"]
            #     except:
            #         message = "mandatory field 'storeCategoryId' missing/Invalid"
            #         response = {"message": message}
            #         return JsonResponse(response, safe=False, status=status.HTTP_400_BAD_REQUEST)
            # ----------------------- Mongo Query -----------------------
    ...
    def post(self, request):
        ...
        try:
            ...
            return JsonResponse(response, safe=False, status=status.HTTP_400_BAD_REQUEST)
        # --------------------------- Request Checking ------------------------------------
        operation = {1: ExportOperations.buyer,
                    #  2: ExportOperations.inventory,
                    #  3: ExportOperations.promo,
                     4: ExportOperations.orders,
                     5: ExportOperations.notify,
                     8: ExportOperations.per_stop_report,
                     9: ExportOperations.sku_sheet,
                     11: ExportOperations.accounting,
                     12: ExportOperations.weekly_payout,
                     13: ExportOperations.store_invoice,
                     }
